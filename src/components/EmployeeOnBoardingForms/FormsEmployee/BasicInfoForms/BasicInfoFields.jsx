...
const employeeTypeTabs = [
  { label: "Full Time / Regular", value: 2 },
...
const BasicInfoFields = ({ formik }) => {
  ...
  /* ---------------- PHOTO SYNC LOGIC ---------------- */
  // 🔴 UPDATED: Sync Preview when values.profilePicture changes (Auto-populate)
  useEffect(() => {
    if (values.profilePicture && typeof values.profilePicture === 'string') {
        setPreviewUrl(values.profilePicture);
    }
  ...
  const handleFileChange = (e) => {
    ...
    // Convert to Base64 for data consistency if needed
  ...
  //   // Only auto-fill if fields are empty to avoid overwriting edits
        ...
        <div className={styles.nameGenderSection}>
         ...
         <div className={styles.twoCol}>
            ...
            <Inputbox
              ...
              error={touched.firstName && errors.firstName} // ✅ Added Error prop
              // disabled removed
            />
          </div>
          ...
          <div className={styles.twoCol}>
            <Inputbox
              ...
              onChange={handleChange} // ✅ Added Change Handler
              error={touched.lastName && errors.lastName} // ✅ Added Error prop
              // disabled removed
            />
